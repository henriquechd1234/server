...
<body>
    ...
    <main class="container">
        ...
        if (isset($_GET['busca']) && !empty($_GET['busca'])) {
            ...
            } // Aqui falta uma chave de fechamento para o `if` da linha 57
        } // Aqui fecha o `else if`
        ?>
    </main>
    ...
    <div class="review-container">
        ...
        $stmt_avaliacao = $mysqli->prepare("SELECT cadastro.nome, avaliacao, nota, data_avaliacao FROM avaliacao 
                                           INNER JOIN cadastro ON avaliacao.cadastro_id = cadastro.id 
                                           WHERE imagens_id = ?");
